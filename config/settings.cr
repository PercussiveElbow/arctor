...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "arctor web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 3uXVKjBcnCD3guP5wymxY6vRl9McC5lOhDfpcPs7LpI
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("arctor.log", "w"))
  #
  #
end
